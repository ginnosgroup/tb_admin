...
import org.zhinanzhen.tb.annotation.RecordLog;
...
@Component
@Slf4j
public class LogUtils extends BaseController {
    /**
     * 默认记录操作日志的DAO层方法名开头
     */
     ...
     * 默认不记录的操作方法（记录日志的方法）
     */
    public static final String[] DEFAULT_NOT_RECORED_METHOD = new String[]{"org.zhinanzhen.b.dao.SysLogDAO.insertLog"};
    ...
    private static List<Object> getParamList(String methodFullName, String desc, String originalSql) {
        ...
        paramList.add(adminUserLoginInfo.getId());
