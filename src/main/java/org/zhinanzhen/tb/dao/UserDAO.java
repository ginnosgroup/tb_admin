...
public interface UserDAO {
	...
	public int countUser(@Param("name") String name, @Param("authNickname") String authNickname,
			@Param("phone") String phone);

	public List<UserDO> listUser(@Param("name") String name, @Param("authNickname") String authNickname,
			@Param("phone") String phone, @Param("offset") int offset, @Param("rows") int rows);
