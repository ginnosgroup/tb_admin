...
public class VisaOfficialController extends BaseCommissionOrderController {
    ...
    public Response<List<VisaOfficialDTO>> add(
        ...
        try {
            ...
            String settlementPhase = StringUtil.isNotEmpty(serviceOrderDto.getCompletionPhase())
                    ? serviceOrderDto.getCompletionPhase() : completionPhase;
            boolean phaseSettlement = StringUtil.isNotEmpty(settlementPhase);
            if (phaseSettlement) {
            ...
            int addResult = visaOfficialService.addVisa(visaDto, settlementPhase);
            if (addResult > 0) {
