    ...
    public Response<Integer> updateServiceOrder(@RequestParam(value = "id") int id,
        ...
        try {
            ...
            Response<Integer> res = updateOne(serviceOrderDto, type, peopleNumber, peopleType, peopleRemarks, serviceId,
                    ...
                    hasInsurance, isTransfer, transferRemarks, servicePackageIds, offerUrl, offerType, officialData, scoreOptions, scoreState, scoreMark, eoiType, isCOE);
            if (res != null && res.getCode() == 0) {
                ...
                cList.forEach(cServiceOrderDto -> {
                    Response<Integer> cRes = updateOne(cServiceOrderDto, null, peopleNumber, peopleType, peopleRemarks,
                            ...
                            insuranceCompany, hasInsurance, isTransfer, transferRemarks, servicePackageIds, offerUrl, offerType, officialData, scoreOptions, scoreState, scoreMark, eoiType, isCOE);
                    if (cRes.getCode() > 0)
...
//                hasInsurance, isTransfer, transferRemarks, servicePackageIds, offerUrl, offerType, officialData, scoreOptions, scoreState, scoreMark);
    ...
    * */
    ...
    private Response<Integer> updateOne(ServiceOrderDTO serviceOrderDto, String type, Integer peopleNumber,
                                        ...
                                        String offerType, String officialData, String scoreOptions, String scoreState, String scoreMark, String eoiType, String isCOE) {
        try {
