...
public class ExchangeRateController extends BaseController {
	...
	public String listDailyExchangeRate(HttpServletRequest request,
		...
		try {
			...
			if (list == null)
				return "汇率查询失败!";
			String html = "<html><head><meta http-equiv='Content-Type' content='text/html; charset=utf-8' /><title>ZNZ实时汇率查询历史记录</title></head><body><table width='50%' border='1' cellpadding='1' cellspacing='1'><tr><td><b>ZNZ收款汇率</b></td> <td><b>更新时间</b></td></tr>";
