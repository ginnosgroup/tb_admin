...
public interface ServiceOrderService {
	...
	int countServiceOrder(String type, List<String> stateList, String reviewState, int userId, int maraId,
			int adviserId, int officialId) throws ServiceException;

	List<ServiceOrderDTO> listServiceOrder(String type, List<String> stateList, String reviewState, int userId,
