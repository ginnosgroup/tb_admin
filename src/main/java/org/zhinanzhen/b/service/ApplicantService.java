...
public interface ApplicantService {
	...
	int count(Integer id, String name, Integer userId, Integer adviserId) throws ServiceException;

	List<ApplicantDTO> list(Integer id, String name, Integer userId, Integer adviserId, int pageNum, int pageSize)
