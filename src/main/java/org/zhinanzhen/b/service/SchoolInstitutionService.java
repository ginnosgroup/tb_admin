...
public interface SchoolInstitutionService {
	...
	List<SchoolInstitutionDTO> listSchoolInstitutionDTO(String name, String type, String code, Boolean isCooperative,
			Boolean isFreeze, int pageNum, int pageSize, String orderBy, String keyword);
