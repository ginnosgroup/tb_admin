...
public enum PortalFollowUpState {
	...
	ADVISER_SERVICE_ORDER_CREATED("05", "顾问已下服务订单", "adviser_service_order_created", null, false, false,
			false),
	OFFICIAL_PREPARING_MATERIALS("06", "准备申请材料中", "official_preparing_application_materials", null, false,
			false, false),
	...
	MATERIALS_PENDING_CUSTOMER_CONFIRM("06B", "申请材料待客户确认", "materials_pending_customer_confirm", null, false,
			false, false),
	CUSTOMER_UPLOADED_MATERIALS("06C", "客户已上传申请材料", "customer_upload_application_materials", null, false,
			false, false),
	...
	CUSTOMER_SUBMITTED_SUPPLEMENT("010D", "客户已上传补充材料", "customer_submit_supplement", null, false, false,
			false),
	CUSTOMER_RETURNED_SUPPLEMENT("010E", "客户退回补充材料", "customer_return_supplement", null, false, false,
			false),
	SUPPLEMENT_PENDING_CUSTOMER_CONFIRM("010F", "补充材料待客户确认", "supplement_pending_customer_confirm", null,
			false, false, false),
	CUSTOMER_CONFIRMED_SUPPLEMENT("010G", "客户已确认补充材料", "customer_confirm_supplement", null,
			false, false, false),
	...
	MARA_APPROVED_SUPPLEMENT("010C", "补料MARA审核通过", "mara_approve_supplement", null, false, false, false),
