...
//            }
    ...
    public List<CommissionInfoDTO> getCommissionInfoById(int id, int adviserId) throws ServiceException {
        ...
        try {
            ...
            if (!commissionInfoDOList.isEmpty() && commissionInfoDOList.size() != commissionInfoDOList.get(0).getInstallment()) {
                commissionInfoDOList = commissionOrderDao.getCommissionInfoById(id, 0);
            }
    ...
    private CommissionOrderListDTO buildCommissionOrderListDto(CommissionOrderListDO commissionOrderListDo) {
        ...
        if ("AUD".equalsIgnoreCase(commissionOrderListDo.getCurrency())) {
			...
			commissionOrderListDto.setTotalAmountAUD(commissionOrderListDto.getTotalAmount());
			commissionOrderListDto
					.setTotalAmountCNY(roundHalfUp2(commissionOrderListDto.getTotalAmount() * exchangeRate));
        ...
        if ("CNY".equalsIgnoreCase(commissionOrderListDo.getCurrency())) {
			...
			commissionOrderListDto
					.setTotalAmountAUD(roundHalfUp2(commissionOrderListDto.getTotalAmount() / exchangeRate));
			commissionOrderListDto.setTotalAmountCNY(commissionOrderListDto.getTotalAmount());
			commissionOrderListDto
