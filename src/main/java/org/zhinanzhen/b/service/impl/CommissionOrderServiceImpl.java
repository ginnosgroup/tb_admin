...
System.out.println(commissionOrderDo.getId()+"====="+!StringUtil.andIsBlank(commissionOrderDo.getPaymentVoucherImageUrl1(),
		commissionOrderDo.getPaymentVoucherImageUrl2()) + "=====" + commissionOrderDo.getAmount());
