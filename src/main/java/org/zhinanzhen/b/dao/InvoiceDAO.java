...
public interface InvoiceDAO {
    ...
    int updateVisaInvoiceNumberNull(@Param("invoiceNo") String invoiceNo);
    ...
    List<InvoiceBillToDO> billToList(@Param("name")String name);
    ...
    String getServicefeeIdsByInvoiceNo(@Param("invoiceNo") String invoiceNo);
