...
//            "1046868,1046869,1046913,1046914)")
    ...
    @Select("select * from b_applicant")
    List<ApplicantDO> listApplicant();

    @Select("select * from b_mara")
    List<MaraDTO> listMara();

    @Select("select * from b_official")
    List<OfficialDTO> listOfficial();

    @Select("select * from tb_adviser")
    List<AdviserDTO> listAdviser();

    @Select("select * from b_receive_type")
    List<ReceiveTypeDTO> listReceiveType();

    @Select("select * from b_service")
    List<ServiceDO> listService();

    @Select("select * from b_service_package")
    List<ServicePackageDO> listServicePackage();

    @Select("select * from b_school")
    List<SchoolDO> listSchool();

    @Select("select * from b_school_institution")
    List<SchoolInstitutionDO> listSchoolInstitution();
}